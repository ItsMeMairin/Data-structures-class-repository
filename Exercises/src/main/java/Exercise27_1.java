...
Create a new concrete class MyHashMap that implements MyMap using open addressing with linear probing. For simplicity, use the same hash function as in LiveExample 27.1.
